...
class PlannerState(TypedDict):
    ...
    # Internal routing key — set by check_goal, read by goal_condition.
    # Was missing from TypedDict — planner writes state["_route"] but
    # TypedDict didn't declare it, causing type checker errors and
    # potential KeyError on strict TypedDict implementations.
    _route: str
